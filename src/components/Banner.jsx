...
const Banner = ({ autoPlayInterval }) => {
    const slides = [
        ...
        { imgSrc: "https://i.ibb.co/55Tq4DY/phono-slider-3.webp", text: "Join Us Today!", textPosition: "left-[75%]", color: 'text-white', button: 'white-btn' },
    ]
    ...
    return (
        <div className="relative overflow-hidden w-full h-[30vh] md:h-[92vh] mx-auto">
                ...
                {slides.map((slide, index) => (
                    <div key={index} className="w-full flex-shrink-0 relative">
                        ...
                        <div className={`absolute ${slide.textPosition}`} style={{ top: '50%', transform: 'translate(-50%, -50%)' }}>
                            ...
                            <button className={`p-2 md:p-3 px-2 md:px-8 ${slide.button}`}>Buy Now</button>
                        </div>
                    </div>
                ))}
            </div>
